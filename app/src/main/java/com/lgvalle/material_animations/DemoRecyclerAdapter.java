...
import com.lgvalle.material_animations.databinding.RowDemoBinding;

import java.util.List;

public class DemoRecyclerAdapter extends RecyclerView.Adapter<DemoRecyclerAdapter.SamplesViewHolder> {
    private final Activity activity;
    private List<Sample> samples;

    public DemoRecyclerAdapter(Activity activity, List<Sample> samples) {
    ...
    public SamplesViewHolder onCreateViewHolder(ViewGroup parent, int position) {
        ...
        RowDemoBinding binding = RowDemoBinding.inflate(LayoutInflater.from(parent.getContext()), parent, false);
    ...
    public void onBindViewHolder(final SamplesViewHolder viewHolder, final int position) {
        ...
        viewHolder.binding.setSampleDemo(sample);
